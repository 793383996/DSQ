...
!(function (o, t) {
  ...
  function o(o, t) {
    ...
    for (var e in o) {
      var n = o[e];
      "className" == e ? ((e = "class"), c.setAttribute(e, n)) : "_" == e[0] && c.addEventListener(e.slice(1), n);
    }
    if ("string" == typeof t) c.innerHTML = t;
    else if ("object" == _typeof(t) && t.tagName) c.appendChild(t);
    else if (t)
  ...
  function s(o, t) {
    ...
    if (n(c, t)) {
      var e = c.split(/\s+/),
        s = e.indexOf(t);
      (e.splice(s, 1), (o.className = e.join(" ")));
    }
    "" === o.className && o.removeAttribute("class");
  }
  function r() {
    return i(arguments, "info");
  }
  function i(o, t) {
    var c = {};
    ...
    for (var n = 0; n < o.length; n++) {
      var s = o[n];
      void 0 !== s &&
        ("string" == typeof s || "object" == _typeof(s)
          ? (c.msg = s)
          : "boolean" == typeof s
            ? (c.showClose = s)
            : "function" == typeof s
              ? (c.onClose = s)
              : "number" == typeof s && (c.duration = s));
    }
    return ((c.type = t), a(c));
  }
  function a(e) {
    var n = e.type,
      ...
      m = 0 === r,
      p = g();
    "loading" == n && ((i = "" === i ? "正在加载..." : i), (m = a), (r = 0));
    var u = o({ className: "coco-msg-wrapper" }, [
        o({ className: "coco-msg coco-msg-fade-in ".concat(n) }, [
          o({ className: "coco-msg-icon" }, p[n]),
          o({ className: "coco-msg-content" }, i),
          o(
            {
      ...
      v = u.querySelector(".coco-msg__circle");
    return (
      v &&
        "loading" !== n &&
        (c(v, { animation: "coco-msg__circle ".concat(r, "ms linear") }),
      ...
      h.children.length || document.body.appendChild(h),
      h.appendChild(u),
      c(u, { height: u.offsetHeight + "px" }),
      setTimeout(function () {
        s(u.children[0], "coco-msg-fade-in");
      }, 300),
      function () {
        l(u, d);
      }
  ...
  function l(o, t) {
    o &&
      (c(o, { padding: 0, height: 0 }),
      e(o.children[0], "coco-msg-fade-out"),
      t && t(),
      setTimeout(function () {
        if (o) {
          for (var t = !1, c = 0; c < h.children.length; c++) h.children[c] === o && (t = !0);
          (t && d(o), (o = null), h.children.length || (t && d(h)));
        }
      }, 300));
  }
  function g() {
  ...
  function p() {
    ...
    if (o && o.head) {
      ...
      ((c.innerHTML = e), t.appendChild(c));
    }
  }
  if ("undefined" != typeof window) {
    var h = o({ className: "coco-msg-stage" }),
      u = { msg: "", duration: 2e3, showClose: !1 },
      v = {
        info: function () {
          return i(arguments, "info");
        },
        success: function () {
          return i(arguments, "success");
        },
        warning: function () {
          return i(arguments, "warning");
        },
        error: function () {
          return i(arguments, "error");
        },
        loading: function () {
          return i(arguments, "loading");
        },
        destroyAll: function () {
          m();
        },
        config: function (o) {
          for (var t in o) Object.hasOwnProperty.call(o, t) && void 0 !== o[t] && (u[t] = o[t]);
        },
      };
    for (var w in v) r[w] = v[w];
    return (p(), r);
  }
});
