...
function generateBlueprint() {
  ...
  let config = {
    maxSorterNumOneBelt: 8, // 单传送带最大分拣器数
    conveyorBeltStackLayer: parseInt(document.getElementById('conveyorBeltStackLayer').value), // 传送带堆叠层数
    x_y_ratio: parseFloat(document.getElementById('x_y_ratio').value), // 蓝图长宽比
    compactLayout: false, // 紧凑布局
